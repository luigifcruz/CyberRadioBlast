...
var CyberRadioCore = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(CyberRadioCore) {
  CyberRadioCore = CyberRadioCore || {};
...
var Module = typeof CyberRadioCore !== 'undefined' ? CyberRadioCore : {};
...
var wasmBinaryFile = 'cyberradio.wasm';
...
var wasmSourceMapFile = 'cyberradio.wasm.map';
if (!isDataURI(wasmBinaryFile)) {
...
function createWasm() {
  ...
  if (!ENVIRONMENT_IS_PTHREAD) { addRunDependency('source-map'); }
  ...
  if (!ENVIRONMENT_IS_PTHREAD) { addRunDependency('offset-converter'); }
...
var ASM_CONSTS = {
  28816: function() {throw 'Canceled!'},  
 29088: function($0, $1) {setTimeout(function() { __emscripten_do_dispatch_to_thread($0, $1); }, 0);},  
 42782: function() {return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); });},  
 63084: function() {var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; }}
};
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread={unusedWorkers:[],runningWorkers:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('cyberradio.worker.js');
  ...
  function invokeEntryPoint(ptr, arg) {
      return (function(a1) { dynCall_ii.apply(null, [ptr, a1]); })(arg);
    }
  ...
  var Asyncify={State:{Normal:0,Unwinding:1,Rewinding:2},state:0,StackSize:10000,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,afterUnwind:null,asyncFinalizers:[],sleepCallbacks:[],getCallStackId:function(funcName) {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(13, 1, name);
...
var proxiedFunctionTable = [null,_atexit,___sys_dup,___sys_exit_group,___sys_open,___sys_stat64,_emscripten_set_canvas_element_size_main_thread,_environ_get,_environ_sizes_get,_fd_close,_fd_read,_fd_seek,_fd_write,_sysconf];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 116188;
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 159064;
var ___heap_base = Module['___heap_base'] = 5845296;
...
Module["WasmOffsetConverter"] = WasmOffsetConverter;
Module["WasmSourceMap"] = WasmSourceMap;
...
run();
  ...
  return CyberRadioCore.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = CyberRadioCore;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return CyberRadioCore; });
else if (typeof exports === 'object')
  exports["CyberRadioCore"] = CyberRadioCore;
